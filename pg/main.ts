...
let itensales = [{id:1, name:1, id_product:3, amount:4, val_product:23, disc_sale:12},
                 {id:2, name:2, id_product:2, amount:4, val_product:25, disc_sale:8},
                 {id:3, name:3, id_product:1, amount:4, val_product:45, disc_sale:7}]
