    ...
    insertItens(itensales) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield exports.client.query('INSERT INTO sales("fk_name_pers") VALUES (' + "'" + this._name + "')");
                ...
                let num_sale = result_num_sale.rows[0].max;
                ...
                yield exports.client.query("UPDATE sales SET val_rec = '" + sub_total_sale + "', disc_sale = '" + this._disc_sale + "', total_sale = '" + total_sale + "' WHERE id_sale = '" + num_sale + "'");
                console.log("atualizado com sucesso");
                const result_update_sale = yield exports.client.query("SELECT *FROM sales WHERE id_sale = '" + num_sale + "';");
